...
jest.mock('../components/calender/TableRowComponent.jsx', () => ({ mail, formatSubject, formatDate, formatTime, handleOpenModal, deleteMail }) => (
  <tr>
    ...
    <td>{mail.status}</td>
    <td>
      <button onClick={() => handleOpenModal(mail.id, mail.title)}>Open Modal</button>
