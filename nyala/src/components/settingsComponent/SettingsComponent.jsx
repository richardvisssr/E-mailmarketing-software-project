          ...
          <div className="my-4">
            {!loading ? (
              <>
                ...
                <p>
                  Beheer algemene instellingen met betrekking tot de applicatie.
                  Aangepaste instellingen worden direct opgeslagen en toegepast.
                </p>
                    ...
                    <div className="row align-items-center">
                      <div className="col">
                        ...
                        <p className="text-muted mb-0">
                          ...
                          geldig is. Deze token wordt verschaft aan een
                          subcriber om mails online te kunnen bekijken of zich
                          in/ uit te kunnen schrijven.
                        </p>
                      </div>
                      <div className="col-auto">
                        <div className="custom-control custom-switch">
                  ...
                  <div className="list-group-item">
                    <div className="row align-items-center">
                      <div className="col">
                        ...
                        <p className="text-muted mb-0">
                          De tijd in minuten wanneer de server moet controleren
                          of er mails verstuurd moeten worden.
                        </p>
                      </div>
                      <div className="col-auto">
                        <div className="custom-control custom-switch">
                    ...
                    {activityLog.length === 0 ? (
                      <tr>
                        <td colSpan="3" className="text-center">
                          Geen activiteiten gevonden, mogelijk heeft u logging
                          uit staan.
                        </td>
                      </tr>
                    ) : (
                      currentEntries.map((entry) => (
                        <tr>
                          <th scope="col">
                            ...
                            {entry.browser} - {entry.osName} {entry.osVersion}
                          </th>
                          <td>{entry.ip}</td>
