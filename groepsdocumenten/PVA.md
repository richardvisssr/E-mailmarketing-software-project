# Toelichting plan van aanpak AIM Versie 4.

## Hoe kom je tot een goed plan van aanpak en wat moet erin staan?

Praktijkbureau AIM, Professional Skills, september 202 2

Dit document geeft een toelichting om te komen tot een plan van aanpak, en op de vereiste inhoud ervan, voor zowel
onderwijsprojecten (propedeuse, semesters) als voor het afstudeerproject.

Omdat een project uitvoeren geen routinematig werk is, is het handig om van tevoren te bedenken wat een passende aanpak is. Die
aanpak leg je vast in een document, het plan van aanpak^1. De functie daarvan is dat je scherp krijgt wat je te doen staat en hoe je dat
vervolgens aanpakt zodat je je resultaat vlot kunt behalen. Het plan van aanpak is een document dat je ‘op het rechte pad houdt’
tijdens je project; waar je op terug kunt vallen als tijdens de uitvoering van het project alles anders loopt dan je had gedacht of
gehoopt.

Met het plan van aanpak in de beroepspraktijk dien je ‘twee heren’. Je opdrachtgever en de opdrachtnemer (jijzelf of het team
waarin je samenwerkt). Voor de opdrachtgever is het belangrijkste dat je een werkend, of in elk geval praktisch toepasbaar product
maakt. Dat lukt natuurlijk alleen maar optimaal als je zelf een heel goed idee hebt wat de opdracht is en hoe je aanpak om te komen
tot het juiste resultaat eruitziet.
Op school is er nog een derde doelgroep: de docenten. Aan de hand van het plan van aanpak kunnen docenten zien of je de
opdracht goed begrepen hebt, en kunnen ze inschatten of het project voldoende kans van slagen heeft. Het plan is voor docenten
hulpmiddel bij de begeleiding. Ook wordt het plan van aanpak in diverse projecten gebruikt voor de toetsing van de individuele
projectvoorbereiding.

In dit document laten we zien hoe je tot een goed plan van aanpak komt.

Natuurlijk moet je weten wat er onder de begrippen wordt verstaan die in het plan van aanpak staan beschreven, maar nog
belangrijker is dat je over de juiste dingen nadenkt, en deze in **_een logische volgorde_** opschrijft, zodat het geheel consistent is, en
geen herhalingen bevat. Je kunt dus in een projectgroep niet zomaar het schrijven van de verschillende hoofdstukken ‘verdelen’
over alle groepsleden.

Zoals gezegd, deze opbouw van het plan van aanpak is geldig voor zowel onderwijs- als afstudeerprojecten. Het verschil zit hem erin
dat bij onderwijsprojecten de op te leveren producten vaak vooraf gegeven zijn, evenals de projectmethodiek. Dat eerste zorgt
ervoor dat de opdracht wat sneller helder zal zijn, het tweede ontslaat jou er niet van de toepasbaarheid van de projectmethodiek
toe te lichten en te verwerken in de planning. Qua beoordeling moeten de plannen van aanpak dan ook aan dezelfde eisen voldoen.

Hieronder wordt aangegeven welke hoofdstukken in het plan van aanpak moeten terugkomen, en waarop binnen die hoofdstukken
tenminste moet worden ingegaan. Voor een toelichting op de gehanteerde begrippen verwijzen we naar (Grit, 2015); het begrip
‘Kosten en Baten’ is echter niet van toepassing voor AIM-projecten. Het gaat om de volgende hoofdstukken:
...
(^1) In de beroepspraktijk heeft niet ieder project een plan van aanpak, maar voorafgaand aan ieder project wordt nagedacht over de aanpak ervan.
Vaak wordt dit ook vastgelegd in een document, ook al heet dat niet altijd plan van aanpak.
...
In dit hoofdstuk maak je een koppeling tussen de ontwikkelmethode en je activiteiten. Geef overzichtelijk weer wanneer de
...
Het is natuurlijk de bedoeling dat je plan van aanpak in één keer perfect is, dan kun je zelf het snelste aan de slag met je project.
